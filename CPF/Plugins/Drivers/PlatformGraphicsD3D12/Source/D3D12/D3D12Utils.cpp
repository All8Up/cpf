...
#include "CPF/Platform/Graphics/ScanlineOrder.hpp"
#include "CPF/Platform/Graphics/ModeScaling.hpp"
#include "CPF/Platform/Graphics/EnumMode.hpp"
#include "CPF/Platform/Graphics/SwapEffect.hpp"
#include "CPF/Platform/Graphics/BindingType.hpp"
#include <dxgi1_2.h>
...
D3D12_RESOURCE_STATES D3D12::Convert(ResourceState resourceState)
{
	...
	case ResourceState::ePresent:					return D3D12_RESOURCE_STATE_COMMON;
...
DXGI_FORMAT D3D12::Convert(const Format pf)
{
	...
	case Format::eBGRA8:	return DXGI_FORMAT_B8G8R8A8_TYPELESS;
	case Format::eBGRA8un:	return DXGI_FORMAT_B8G8R8A8_UNORM;
