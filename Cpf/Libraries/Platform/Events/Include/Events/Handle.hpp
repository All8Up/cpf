...
{
	template<>
	struct hash < Cpf::Platform::Events::HandleBase >
	{
		size_t operator ()(const Cpf::Platform::Events::HandleBase& eh) const
		{
			hash<void*> ptrHash;
	...
	template<>
	struct hash < Cpf::Platform::Events::Handle >
	{
		size_t operator ()(const Cpf::Platform::Events::Handle& eh) const
		{
			hash<Cpf::Platform::Events::HandleBase> baseHasher;
