	...
	namespace SIMD
	{
		...
		*/
		namespace SSE4_1
		{
			...
			//////////////////////////////////////////////////////////////////////////
			template <int COUNT>
			CPF_FORCE_INLINE bool CPF_VECTORCALL operator == (const I32x4_<COUNT> lhs, const I32x4_<COUNT> rhs)
			{
			...
			CPF_FORCE_INLINE I32x4_<COUNT> CPF_VECTORCALL operator * (const I32x4_<COUNT> lhs, const I32x4_<COUNT> rhs)
			{
				return I32x4_<COUNT>(_mm_mul_epi32(static_cast<__m128i>(lhs), static_cast<__m128i>(rhs)));
			}
			template <int COUNT>
			CPF_FORCE_INLINE I32x4_<COUNT> CPF_VECTORCALL operator / (const I32x4_<COUNT> lhs, const I32x4_<COUNT> rhs)
			{
				// WTF, where is the instruction??
				// return I32x4_<COUNT><COUNT>(_mm_div_epi32(static_cast<__m128i>(lhs), static_cast<__m128i>(rhs)));
			...
			template <int COUNT>
			CPF_FORCE_INLINE I32x4_<COUNT> CPF_VECTORCALL Clamp(const I32x4_<COUNT> value, const I32x4_<COUNT> low, const I32x4_<COUNT> high)
			{
				return I32x4_<COUNT>(_mm_min_epi32(static_cast<__m128>(high), _mm_max_epi32(static_cast<__m128i>(low), static_cast<__m128i>(value))));
			}
			template <int COUNT>
