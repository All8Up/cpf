...
namespace Cpf
{
	namespace Math
	{
		...
		template <typename TYPE>
		CPF_FORCE_INLINE typename Vector2v<TYPE>::Element CPF_VECTORCALL HMin(Vector2v<TYPE> value)
		{
		...
		template <typename TYPE>
		CPF_FORCE_INLINE typename Vector2v<TYPE>::Element CPF_VECTORCALL HMax(Vector2v<TYPE> value)
		{
