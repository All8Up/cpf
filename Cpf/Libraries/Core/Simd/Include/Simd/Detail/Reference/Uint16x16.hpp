...
namespace Cpf
{
	namespace Simd
	{
		namespace Reference
		{
			...
			//////////////////////////////////////////////////////////////////////////
			inline Uint16x16::ValueType Uint16x16::Load(const ElementType* const data)
			{
				ValueType result;
			...
			inline Uint16x16::ValueType Uint16x16::Create(
				ElementType v0, ElementType v1, ElementType v2, ElementType v3, ElementType v4, ElementType v5, ElementType v6, ElementType v7,
				ElementType v8, ElementType v9, ElementType v10, ElementType v11, ElementType v12, ElementType v13, ElementType v14, ElementType v15)
			{
				ValueType result = { {
			...
			inline Uint16x16::ValueType Uint16x16::LoadUnaligned(const ElementType* const data)
			{
				ValueType result;
			...
			inline Uint16x16::ElementType Uint16x16::GetLane(ConstRef a, int idx)
			{
				return a.data[idx];
			}

			inline Uint16x16::ValueType Uint16x16::SetLane(ConstRef a, ElementType v, int idx)
			{
				ValueType result = a;
				result.data[idx] = v;
				return result;
			...
			inline Uint16x16::ValueType Uint16x16::Add(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
			...
			inline Uint16x16::ValueType Uint16x16::AddSaturate(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
				{
					int temp = int(a.data[i]) + int(b.data[i]);
					result.data[i] = ElementType(temp >= 255 ? 255 : temp <= 0 ? 0 : temp);
				}
				return result;
			}

			inline Uint16x16::ValueType Uint16x16::Sub(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
					result.data[i] = a.data[i] - b.data[i];
			...
			inline Uint16x16::ValueType Uint16x16::SubSaturate(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
				{
			...
			inline Uint16x16::ValueType Uint16x16::And(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
					result.data[i] = a.data[i] & b.data[i];
			...
			inline Uint16x16::ValueType Uint16x16::AndNot(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
				{
			...
			inline Uint16x16::ValueType Uint16x16::Or(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
					result.data[i] = a.data[i] | b.data[i];
			...
			inline Uint16x16::ValueType Uint16x16::Xor(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
					result.data[i] = a.data[i] ^ b.data[i];
			...
			inline Uint16x16::ValueType Uint16x16::Min(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
			...
			inline Uint16x16::ValueType Uint16x16::Max(ConstRef a, ConstRef b)
			{
				ValueType result;
				for (int i = 0; i < kElementCount; ++i)
					result.data[i] = a.data[i] >= b.data[i] ? a.data[i] : b.data[i];
