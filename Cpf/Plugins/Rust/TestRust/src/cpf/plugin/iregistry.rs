...
pub struct iRegistry_Vtbl
{
    ...
    pub CanUnload: extern "stdcall" fn(this: *mut iRegistry, library: *const ::libc::c_char) -> u32,
    ...
    pub Create: extern "stdcall" fn(this: *mut iRegistry, outer: *mut gom::iBase, cid: u64, iid: u64, outIFace: *mut *mut ::libc::c_void) -> u32,
    ...
    pub InstanceInstall: extern "stdcall" fn(this: *mut iRegistry, id: u64, instance: *mut gom::iBase) -> u32,
    pub InstanceRemove: extern "stdcall" fn(this: *mut iRegistry, id: u64) -> u32,
    pub GetInstance: extern "stdcall" fn(this: *mut iRegistry, id: u64, outIface: *mut gom::iBase) -> u32,
}
