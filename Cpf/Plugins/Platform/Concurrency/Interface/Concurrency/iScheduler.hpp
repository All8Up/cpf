...
namespace Cpf
{
	...
	{
		static constexpr GOM::ClassID kSchedulerCID = GOM::ClassID("Cpf::iScheduler"_crc64);
		...
		struct iScheduler : GOM::iUnknown
		{
			...
			virtual GOM::Result CPF_STDCALL Initialize(int threadCount, WorkFunction init, WorkFunction shutdown, void* context) = 0;
