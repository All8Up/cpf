	...
	namespace Driver
	{
		namespace D3D12
		{
			...
			public:
				...
				GOM::Result CPF_STDCALL Initialize();
				...
				GOM::Result CPF_STDCALL CreateFence(bool signaled, Graphics::iFence**) override;
				...
				GOM::Result CPF_STDCALL Signal(Graphics::iFence*) override;
