...
doc_stmt                : doc_brief
                        | doc_param
                        | doc_result;
doc_brief               : DOC_BRIEF STRING_LIT;
doc_param               : DOC_PARAM IDENT STRING_LIT;
doc_result              : DOC_RESULT STRING_LIT;
...
// Parse comments into the AST for documentation purposes.
...
option_type             : OPTION LT type_decl GT;

outcome_type			: OUTCOME LT type_decl outcome_error? GT;
outcome_error			: COMMA type_decl;
