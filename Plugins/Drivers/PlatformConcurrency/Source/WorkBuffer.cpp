...
/**
* @brief Execute the payload with the last thread while other workers use an os sleep.
* @param func The payload to execute.
* @param context The opaque data associated with the payload.
*/
void CPF_STDCALL WorkBuffer::LastOneSleep(WorkFunction func, void* context)
{
	(*this)(Detail::Opcodes::LastOneSleep, func, context);
}
...
{
	using OpMap = STD::UnorderedMap<Scheduler::OpcodeFunc_t, Op>;
	static OpMap sOpMap{
		...
		{&Detail::Opcodes::LastOneSleep, Op::eLastOneSleep}
	};
