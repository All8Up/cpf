...
namespace Cpf
{
	namespace Platform
	{
		namespace Events
		{
			 ...
			 */
			template< const size_t ID, typename FUNCDECL, typename INTEGRATOR = Integrators::LastOf<typename FUNCDECL::result_type> >
			 ...
			 * @return A Id_t.
			 */
			template< const size_t ID, typename FUNCDECL, typename INTEGRATOR >
